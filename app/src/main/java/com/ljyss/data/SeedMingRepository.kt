...
object SeedMingRepository : MingRepository {
    ...
    private val peopleData = listOf(
        ...
        HistoricalPerson("郑和", "内官监太监", "永乐", "1371—1433", "七下西洋，沟通东南亚与印度洋世界。", PersonCategory.EUNUCHS),
        HistoricalPerson("王振", "司礼监太监", "正统", "？—1449", "正统朝的重要宦官。", PersonCategory.EUNUCHS),
        ...
        HistoricalPerson("汪直", "西厂提督", "成化", "？—？", "成化朝宦官，曾与西厂设置相关。", PersonCategory.EUNUCHS),
        HistoricalPerson("谷大用", "司礼监太监", "正德", "？—1527", "正德朝内廷人物，“八虎”之一。", PersonCategory.EUNUCHS),
        HistoricalPerson("张永", "司礼监太监", "正德", "？—1529", "正德朝内廷人物，参与平定宁王之乱后的政局。", PersonCategory.EUNUCHS),
