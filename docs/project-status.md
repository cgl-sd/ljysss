...
- 左上角书眉（鼎＋两京一十三省）可拉出左侧功能侧栏：分列四页入口与应用更新；“应用更新”手动检查 GitHub 最新 release（cgl-sd/ljysss），发现新版本时下载整包 APK 并经系统安装器升级。
...
- `backend/sources/` 保存中文维基与《明史》两套权威原始数据包；它们受保护且不可作为清理目标。
